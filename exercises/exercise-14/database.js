...
var Database = /** @class */ (function () {
    ...
    Database.prototype.find = function (query, options) {
        return __awaiter(this, void 0, void 0, function () {
            var records, projection_1, sort;
            var _this = this;
            return __generator(this, function (_a) {
                records = this.records.filter(function (e) { return _this.match(query, e); });
                if (options) {
                    ...
                    if ("projection" in options && projection_1 !== undefined) {
                        return [2 /*return*/, records.map(function (r) { return _this.projection(r, projection_1); })];
                    }
                }
    ...
    Database.prototype.projection = function (element, projection) {
    ...
    Database.prototype.sort = function (elements, options) {
        var sortKeysArr = Object.keys(options);
        var invertedArr = sortKeysArr.reverse();
        var _loop_1 = function (sortOption) {
            elements.sort(function (e1, e2) {
                var v1 = e1[sortOption];
                var v2 = e2[sortOption];
                if (v1 === v2) {
                    return 0;
                }
                var a = options[sortOption];
                return v1 < v2 ? -a : a;
            });
        };
        for (var _i = 0, invertedArr_1 = invertedArr; _i < invertedArr_1.length; _i++) {
            var sortOption = invertedArr_1[_i];
            _loop_1(sortOption);
        }
    };
    ...
    Database.prototype.readFile = function () {
        var entryLines = mz_1.fs
            .readFileSync(this.filename)
            .toString()
            .split("\n")
            .filter(function (s) { return !s.match(/^D/) && !s.match(/^[\s]*$/); })
